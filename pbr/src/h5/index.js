...
function addLight(scene) {
    let aLight = new THREE.PointLight(0xffffff, 1, 0, 2);
    aLight.position.set(0, 20, 50)
    scene.add(aLight)
}
...
function addShapes(scene) {
    ...
    let textureCube = loader.load([
        require('./img/px.png'), require('./img/nx.png'),
        require('./img/py.png'), require('./img/ny.png'),
        require('./img/pz.png'), require('./img/nz.png')
    ]);
    let geometry = new THREE.SphereBufferGeometry(10, 30, 30);
    ...
    let skyG = new THREE.BoxBufferGeometry(1000,1000,1000);
    let uniforms = THREE.ShaderLib.cube.uniforms
    ...
    let sky = new THREE.Mesh(skyG,skyM)
    scene.add(sky)
}
